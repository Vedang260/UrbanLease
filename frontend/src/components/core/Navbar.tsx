              ...
              <AnimatePresence>
                {isProfileOpen && (
                  ...
                  >
                    ...
                    <div className="py-1">
                      <Link to="/profile" className="flex items-center w-full px-4 py-2 text-sm text-secondary-700 hover:bg-neutral-50">
                        <FontAwesomeIcon icon={faUser} className="mr-3 text-secondary-400" />
                        My Profile
                      </Link>
                      <Link to="/settings" className="flex items-center w-full px-4 py-2 text-sm text-secondary-700 hover:bg-neutral-50">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-3 text-secondary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
            <div className="px-4 pt-2 pb-4 space-y-1 bg-white border-t border-neutral-100">
              {navItems.map((item) => (
                ...
                >
                  <FontAwesomeIcon icon={item.icon} className="mr-3 text-accent-default" />
                  {item.name}
                </Link>
              ))}
